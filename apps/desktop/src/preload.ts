...
import { desktopUpdateTransport, installDesktopTitleBar, type DesktopMenuAnchor } from './titlebar.ts'
...
installDesktopTitleBar({
  ...
  locale: () => ipcRenderer.invoke(DESKTOP_IPC.localeGet) as ReturnType<DshDesktopApi['locale']>,
