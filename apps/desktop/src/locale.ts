...
export const en = {
  ...
  aboutTitle: 'DeepSeek Harness Desktop',
  aboutDetail: 'This desktop application is an Electron shell around the dsh Web interface. It carries its own Node.js runtime, pnpm, and the matching dsh packages, and shares sessions, settings, and credentials with the other entries.\n\nProject: {project}\nUpstream: {upstream}',
  aboutOpenProject: 'Open GitHub Project',
  aboutClose: 'Close',
...
export const zh = {
  ...
  aboutTitle: 'DeepSeek Harness 桌面版',
  aboutDetail: '桌面版是 dsh Web 界面的 Electron 外壳，自带 Node.js 运行时、pnpm 与匹配版本的 dsh 包，并与其他入口共享会话、设置与凭据。\n\n项目地址：{project}\n上游项目：{upstream}',
  aboutOpenProject: '打开 GitHub 项目',
  aboutClose: '关闭',
