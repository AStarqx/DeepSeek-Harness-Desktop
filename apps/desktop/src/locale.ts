...
export const en = {
  ...
  updateBadgeChecking: 'Checking for updates…',
  updateBadgeAvailable: 'Update {version}',
  updateBadgeAvailableHint: 'Download and install DeepSeek Harness {version}',
  updateBadgeDownloading: 'Downloading {percent}%',
  updateBadgeInstalling: 'Installing…',
  updateBadgeReady: 'Restarting to install…',
  updateBadgeFailed: 'Update check failed — click to retry',
...
export const zh = {
  ...
  updateBadgeChecking: '正在检查更新…',
  updateBadgeAvailable: '有新版本 {version}',
  updateBadgeAvailableHint: '下载并安装 DeepSeek Harness {version}',
  updateBadgeDownloading: '正在下载 {percent}%',
  updateBadgeInstalling: '正在安装…',
  updateBadgeReady: '正在重启安装…',
  updateBadgeFailed: '检查更新失败，点击重试',
